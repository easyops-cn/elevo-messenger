# Contributing to Elevo Messenger
...
> - Star the project
> - Tweet about it (tag @elevo-messenger)
> - Refer this project in your project's readme
> - Mention the project at local meetups and tell your friends/colleagues

## Bug reports

Bug reports and feature suggestions must use descriptive and concise titles and be submitted to [GitHub Issues](https://github.com/easyops-cn/elevo-messenger/issues). Please use the search function to make sure that you are not submitting duplicates, and that a similar report or request has not already been resolved or rejected.
...
**For any query or design discussion, join our [Matrix room](https://matrix.to/#/#elevo-messenger:matrix.org).**
